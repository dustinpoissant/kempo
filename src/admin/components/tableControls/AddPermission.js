...
export default class AddPermission extends AdminTableControl {
  groupName = '';
  ...
  connectedCallback(){
    ...
    if(!this.hasAttribute('title')) this.title = 'Add Permission';
  }

  handleAction(){ this.addPermission(); }

  render(){ return html`<k-icon name="lock_add"></k-icon>`; }
}
