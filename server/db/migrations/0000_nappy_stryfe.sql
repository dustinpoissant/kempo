...
CREATE INDEX "content_name_idx" ON "content" USING btree ("name");--> statement-breakpoint
CREATE INDEX "content_path_idx" ON "content" USING btree ("path");--> statement-breakpoint
